# This time lets increase the reward when in the bottom state and action of trying to 
# drive for staying at the bottom of the state and see how that affects the policy


def value_iteration(states, actions, transition_probs, rewards, gamma=0.9, theta=1e-10):
